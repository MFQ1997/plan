...
public class QiniuCloudUtil {
    ...
    // 设置需要操作的账号的AK和SK
    private static final String ACCESS_KEY = "l0deAsAN88esNDYIo0UlA2BIuAJBOollmvfeG37z";
    private static final String SECRET_KEY = "zh7dWYx2EE9uJP9y5LZUelIDDVsZQ7kFNqfjb7CC";
    // 要上传的空间
    private static final String bucketname = "maifaqiang";
    // 密钥
    private static final Auth auth = Auth.create(ACCESS_KEY, SECRET_KEY);
    //上传的域名
    private static final String DOMAIN = "q2cuy151v.bkt.clouddn.com";
